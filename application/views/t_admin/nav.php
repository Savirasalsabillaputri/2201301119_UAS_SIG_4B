...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?php echo base_url('taman') ?>">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Data Taman</span></a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" href="<?php echo base_url('taman/peta') ?>">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="<?php echo base_url('dashboard/profil') ?>">
                                ...
                                <img class="img-profile rounded-circle"
                                    src="<?=base_url("file/".$this->session->userdata('foto'))?>">
                            </a>
